...
m.reply(espera)
let res = await fetch("https://zenzapis.xyz/downloader/tiktok?apikey=hdiiofficial&url="+args[0])
let json = await res.json()
conn.sendFile(m.chat, json.result.audio, 'error.mp3', null, m, false, { mimetype: 'audio/mp3' })}
if (command == 'tiktok') {
